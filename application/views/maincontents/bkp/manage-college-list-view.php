    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
      ...
      <div class="panel panel-flat"> 
        ...
        <div class="panel-heading">
            <a href="<?php echo base_url();?>index.php/admin/manage_college/newsletter" class="btn bg-teal-400 btn-labeled btn-rounded"><b><i class="fa fa-hand-o-right"></i></b>Send College Newsletter</a>								
		</div>
        ...
        <table class="table datatable datatable-column-search-inputs" id="">
          ...
          <tbody>
            ...
            <tr>
              <td><?php echo $s++; ?></td>
              <td><?php echo $row->college_cat; ?></td>
              <td><?php 
              ...
              <td class="text-center"><ul class="icons-list">
                  ...
                  <li class="dropdown"> <a href="dataSub-Committeele_advanced.htm#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-bars"></i></a>
                    <ul class="dropdown-menu dropdown-menu-right">
                      <li class="divider"></li>
                      <li><a href="<?php echo base_url(); ?>index.php/admin/manage_College/view/<?php echo $row->id; ?>"><i class="fa fa-eye"></i> View</a></li>
                      <li><a onclick="return confirm('Are you sure?')" href="<?php echo base_url(); ?>index.php/admin/manage_College/confirmDelete/<?php echo $row->id; ?>"><i class="fa fa-trash"></i> Delete</a></li>
                      <?php if($row->published==1) { ?>
                      <li><a onclick="return confirm('Are you sure?')" href="<?php echo base_url(); ?>index.php/admin/manage_College/deactive/<?php echo $row->id; ?>"><i class="icon icon-cross2"></i> Deactivate</a></li>
                      <?php } else { ?>
                      <li><a onclick="return confirm('Are you sure?')" href="<?php echo base_url(); ?>index.php/admin/manage_College/active/<?php echo $row->id; ?>"><i class="icon icon-checkmark3"></i> Activate</a></li>
                      <?php } ?>
                    </ul>
                  </li>
                </ul></td>
