  ...
  <div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
      ...
      <div class="panel panel-flat">
        <div class="panel-heading"> <a href="<?php echo base_url();?>index.php/admin/manage_placement/add" class="btn bg-teal-400 btn-labeled btn-rounded"><b><i class="fa fa-hand-o-right"></i></b>Add Placement</a> </div>
        <?php if(empty($rows)) { ?>
        ...
        <table class="table datatable datatable-column-search-inputs" id="">
          ...
          <tbody>
            ...
            <tr>
              ...
              <!--<td><img src="<?php echo base_url(); ?>uploads/placement/<?php echo $row->company_logo; ?>" width="100" height="50" /></td>-->
              <td><?php echo $row->number_of_intake; ?></td>
              <td><?php if($row->published==1) { ?>
                <a onclick="return confirm('Are you sure?')" href="<?php echo base_url(); ?>index.php/admin/manage_placement/deactive/<?php echo $row->placement_id; ?>">
                <?php } else { ?>
                <a onclick="return confirm('Are you sure?')" href="<?php echo base_url(); ?>index.php/admin/manage_placement/active/<?php echo $row->placement_id; ?>">
                <?php } ?>
                <span class="<?php echo ($row->published==1)?'label label-success':'label label-danger'; ?>"><?php echo ($row->published==1)?'Active':'Inactive'; ?></span></a></td>
              <td class="text-center"><ul class="icons-list">
                  ...
                  <li class="dropdown"> <a href="datatable_advanced.htm#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-bars"></i></a>
                    <ul class="dropdown-menu dropdown-menu-right">
                      <li><a href="<?php echo base_url(); ?>index.php/admin/manage_placement/edit/<?php echo $row->placement_id; ?>"><i class="fa fa-edit"></i> Edit</a></li>
                      <li><a onclick="return confirm('Are you sure?')" href="<?php echo base_url(); ?>index.php/admin/manage_placement/confirmDelete/<?php echo $row->placement_id; ?>"><i class="fa fa-trash"></i> Delete</a></li>
                    </ul>
                  </li>
                </ul></td>
            </tr>
