	...
	<div class="page-header">
		...
		<div class="page-header-content">
			...
			<div class="page-title">
				...
				<h4><i class="fa fa-th-large position-left"></i> Manage SSR</h4>
			...
			<ul class="breadcrumb">
				...
				<!--<li><a href="<?php echo base_url(); ?>index.php/admin/site_setting">Manage SSR</a></li>-->

				<li class="active"><?php echo $action; ?> SSR</li>
						...
						<!--<form class="form-horizontal" action="form_basic.htm#">	-->						
						 ...
						 <?php 	$attributes = array('class' => 'form-horizontal', 'id' => 'myform');
							...
							<div class="form-group">
								...
								<label class="control-label col-lg-2">SSR</label>
								...
								<div class="col-lg-10">
                                    ...
                                    <!--<img src="<?php echo base_url();?>uploads/<?php echo $row->ssr; ?>" height="100" width="400"/>-->
                                    <a target="_blank" href="<?php echo base_url(); ?>uploads/<?php echo $row->ssr; ?>"><i class="fa fa-download"></i> <?php echo $row->ssr; ?></a>
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
									...
									<button type="submit" class="btn btn-danger btn-rounded"><?php echo $action; ?> SSR</button>
