	...
	<div class="page-header">
		<div class="page-header-content">
			...
			<ul class="breadcrumb">
				...
				<li><a href="<?php echo base_url(); ?>index.php/admin/manage_tab">Manage Non-Teaching Staff Category</a></li>
				<li class="active"><?php echo $action; ?> Non-Teaching Staff Category</li>
			</ul>					
		</div>
	</div>
<!-- /page header -->
						...
						<!--<form class="form-horizontal" action="form_basic.htm#">	-->						
						 <?php 	$attributes = array('class' => 'form-horizontal', 'id' => 'myform');
                            ...
                            <div class="form-group">
								<label class="control-label col-lg-4">Non-Teaching Staff Category Name</label>
								<div class="col-lg-8">
									
                                    <input type="text" class="form-control" placeholder="Enter Non-Teaching Staff Category Name" name="tab_name" value="<?php if($action == 'Edit'){echo $tab_name;} else {echo set_value('tab_name');} ?>">
                                     <?php echo form_error('tab_name'); ?>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-lg-8">
									<button type="submit" class="btn btn-danger btn-rounded"><?php echo $action; ?> Non-Teaching Staff Category</button>
								</div>
							</div>							
						<?php echo form_close(); ?>					
					</div>
