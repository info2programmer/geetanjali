					...
					<div class="panel-body no-padding-bottom">
						<!--<form class="form-horizontal" action="form_basic.htm#">	-->						
						 <?php 	$attributes = array('class' => 'form-horizontal', 'id' => 'myform');
							...
							<input type="hidden" name="mode" value="Sub-Committee" />
							
                            <div class="form-group">
								<label class="control-label col-lg-2">Sub-Committee Name</label>
								<div class="col-lg-10">
                            ...
                            <div class="form-group">
								...
								<div class="col-lg-10">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter Designation" name="designation" value="<?php if($action == 'Edit'){echo $designation;} else {echo set_value('designation');} ?>">
							...
							<div class="form-group">
								...
								<div class="col-lg-8">
									<button type="submit" class="btn btn-danger btn-rounded"><?php echo $action; ?> Sub-Committee</button>
								</div>
							</div>							
						<?php echo form_close(); ?>					
					</div>
