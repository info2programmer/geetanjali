...
<div class="content">
  <div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
      ...
      <div class="panel-heading"> <a href="<?php echo base_url();?>index.php/admin/manage_forum/add" class="btn bg-teal-400 btn-labeled btn-rounded"><b><i class="fa fa-hand-o-right"></i></b>Add Forum Topic</a> </div>       
        <?php if(empty($rows)) { ?>
        ...
        <table class="table datatable datatable-column-search-inputs" id="">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><span class="<?php echo ($row->published==1)?'label label-success':'label label-danger'; ?>"><?php echo ($row->published==1)?'Active':'Inactive'; ?></span>
              ...
              <td class="text-center"><ul class="icons-list">
                  ...
                  <li class="dropdown"> <a href="datatable_advanced.htm#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-bars"></i></a>
                    <ul class="dropdown-menu dropdown-menu-right">
                      <li class="divider"></li>
                      <li><a href="<?php echo base_url(); ?>index.php/admin/manage_forum/edit/<?php echo $row->thread_id; ?>"><i class="fa fa-edit"></i> Edit</a></li>
                      <li><a onclick="return confirm('Are you sure?')" href="<?php echo base_url(); ?>index.php/admin/manage_forum/view/<?php echo $row->thread_id; ?>"><i class="fa fa-eye"></i> View</a></li>
                      <!--<li><a onclick="return confirm('Are you sure?')" href="<?php echo base_url(); ?>index.php/admin/manage_forum/confirmDelete/<?php echo $row->thread_id; ?>"><i class="fa fa-trash"></i> Delete</a></li>  -->                    
                    </ul>
                  </li>
                </ul></td>
            </tr>
