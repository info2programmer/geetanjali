...
<div class="page-header">
  <div class="page-header-content">
    ...
    <ul class="breadcrumb">
      ...
      <li><a href="<?php echo base_url(); ?>index.php/admin/manage_ads/section_ad">Manage Section Ad</a></li>
      <li class="active"><?php echo $action; ?> Section Ad</li>
    </ul>
  </div>
</div>
<!-- /page header -->
      ...
      <div class="panel panel-flat">
        ...
        <div class="panel-body no-padding-bottom">
          ...
          <div class="form-group">
            ...
            <div class="col-lg-8">
              <?php 
				$js = 'class="form-control" id=section_name';
				echo form_dropdown('section_name',$pages,$section_name,$js);
				echo form_error('section_name'); 
			?>
            </div>
          </div>
          <div class="form-group">
            <label class="control-label col-lg-4">Section Ad</label>
            <div class="col-lg-8">
              <?php if($action == 'Edit') { ?>
              <img src="<?php echo base_url(); ?>uploads/section_ad/<?php echo $row->filename; ?>" width="100" height="100" />
              <?php } ?>
          ...
          <div class="form-group">
            ...
            <div class="col-lg-8">
              <button type="submit" class="btn btn-danger btn-rounded"><?php echo $action; ?> Section Ad</button>
            </div>
          </div>
