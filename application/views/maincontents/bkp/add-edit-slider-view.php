	...
	<div class="page-header">
		...
		<div class="page-header-content">
			...
			<ul class="breadcrumb">
				...
				<li><a href="<?php echo base_url(); ?>index.php/admin/manage_slider">Manage Banner</a></li>

				<li class="active"><?php echo $action; ?> Banner</li>
						 ...
						 <?php 	$attributes = array('class' => 'form-horizontal', 'id' => 'myform');
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
                                    ...
                                    <img src="<?php echo base_url();?>uploads/slider/<?php echo $slider_image;?>" height="100" width="100"/>
                                    ...
                                    <span>( Please upload 390 x 80)</span>
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
									...
									<button type="submit" class="btn btn-danger btn-rounded"><?php echo $action; ?> Banner</button>
