	...
	<div class="page-header">
		...
		<div class="page-header-content">
			...
			<ul class="breadcrumb">
				...
				<li><a href="<?php echo base_url(); ?>index.php/admin/manage_magazine_prospectus">Manage Calendar(Administrative & Academic) Magazine & Prospectus</a></li>

				<li class="active"><?php echo $action; ?> Calendar(Administrative & Academic) Magazine & Prospectus</li>
						...
						<!--<form class="form-horizontal" action="form_basic.htm#">	-->						
						 ...
						 <?php 	$attributes = array('class' => 'form-horizontal', 'id' => 'myform');
                            ...
                            <div class="form-group">
								...
								<label class="control-label col-lg-2">Nature </label>

								<div class="col-lg-10">

                                    <select name="nature" class="form-control">
                                    	<option value="" selected="selected" hidden>Select Nature</option>
                                    	<option value="Magazine" <?php if($action == 'Edit'){ if($nature=='Magazine') { ?>selected="selected"<?php } } ?>>College Magazine</option>
                                        <option value="Prospectus" <?php if($action == 'Edit'){ if($nature=='Prospectus') { ?>selected="selected"<?php } } ?>>College Prospectus</option>
                                        <option value="Administrative_Calender" <?php if($action == 'Edit'){ if($nature=='Administrative_Calender') { ?>selected="selected"<?php } } ?>>Administrative Calender</option>
                                        <option value="Academic_Calender" <?php if($action == 'Edit'){ if($nature=='Academic_Calender') { ?>selected="selected"<?php } } ?>>Academic Calender</option>
                                    </select>
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
                                   ...
                                   <a target="_blank" href="<?php echo base_url(); ?>uploads/maga_pros/<?php echo $row->slider_image; ?>"><i class="fa fa-download"></i> Download</a>
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
									...
									<button type="submit" class="btn btn-danger btn-rounded"><?php echo $action; ?> Calendar(Administrative & Academic) Magazine & Prospectus</button>
