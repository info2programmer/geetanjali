...
<div class="page-header">
  <div class="page-header-content">
    ...
    <ul class="breadcrumb">
      ...
      <li><a href="<?php echo base_url(); ?>index.php/admin/manage_message">Manage Message</a></li>
        ...
        <div class="col-md-12">
         ...
         <?php } ?>              
          ...
          <form action="<?php echo base_url();?>admin/manage_message/view/<?php echo $row->message_id; ?>" method="post">
                ...
                <input type="hidden" name="to_msg" value="<?php $m_id = $row->message_id;$details = $this->db->query("select * from td_messages")->row();echo $details->user_id;?>">
