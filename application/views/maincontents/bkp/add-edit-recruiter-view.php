	...
	<div class="page-header">
		...
		<div class="page-header-content">
			...
			<ul class="breadcrumb">
				...
				<li><a href="<?php echo base_url(); ?>index.php/admin/manage_recruiter">Manage Recruiter</a></li>

				<li class="active"><?php echo $action; ?> Recruiter</li>
					...
					<div class="panel-body no-padding-bottom">
						...
						<!--<form class="form-horizontal" action="form_basic.htm#">	-->						
						 ...
						 <?php 	$attributes = array('class' => 'form-horizontal', 'id' => 'myform');
							...
							<input type="hidden" name="mode" value="recruiter" />

							<div class="form-group">

								<label class="control-label col-lg-2">Recruiter</label>

								<div class="col-lg-10">

									<?php if($action == 'Edit') { ?>                                   

                                    <img src="<?php echo base_url();?>uploads/recruiter/<?php echo $row->recruiter; ?>" height="100" width="150"/>
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
									...
									<button type="submit" class="btn btn-danger btn-rounded"><?php echo $action; ?> Recruiter</button>
