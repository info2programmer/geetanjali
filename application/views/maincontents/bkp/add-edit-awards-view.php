...
<div class="page-header">
  <div class="page-header-content">
    ...
    <ul class="breadcrumb">
      ...
      <li><a href="<?php echo base_url(); ?>index.php/admin/manage_discipline">Manage Awards</a></li>
      <li class="active"><?php echo $action; ?> Awards</li>
    </ul>
  </div>
</div>
      ...
      <div class="panel panel-flat">
        ...
        <div class="panel-body no-padding-bottom"> 
          ...
          <div class="form-group">
            <label class="control-label col-lg-4">Awards Name</label>
            <div class="col-lg-8">
              <input type="text" class="form-control" placeholder="Enter Awards Name" name="award_description" value="<?php if($action == 'Edit'){echo $award_description;} else {echo set_value('award_description');} ?>">
              <?php echo form_error('award_description'); ?> </div>
          </div>
          <div class="form-group">
            <label class="control-label col-lg-4"></label>
            <div class="col-lg-8">
              <button type="submit" class="btn btn-danger btn-rounded"><?php echo $action; ?> Awards</button>
            </div>
          </div>
