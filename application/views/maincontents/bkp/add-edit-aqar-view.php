	...
	<div class="page-header">
		...
		<div class="page-header-content">
			...
			<ul class="breadcrumb">
				...
				<li><a href="<?php echo base_url(); ?>index.php/admin/manage_aqar">Manage AQAR</a></li>

				<li class="active"><?php echo $action; ?> AQAR</li>
					...
					<div class="panel-body no-padding-bottom">
						...
						<!--<form class="form-horizontal" action="form_basic.htm#">	-->						
						 ...
						 <?php 	$attributes = array('class' => 'form-horizontal', 'id' => 'myform');
							...
							<input type="hidden" name="mode" value="aqar" />
                            
                            <div class="form-group">

								<label class="control-label col-lg-2">Title Name </label>

								<div class="col-lg-10">
                                    
                                    <input type="text" class="form-control" placeholder="Enter Title Name" name="title" value="<?php if($action == 'Edit'){echo $title;} else {echo set_value('title');} ?>">
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
                                   ...
                                   <a target="_blank" href="<?php echo base_url(); ?>uploads/aqar/<?php echo $row->slider_image; ?>"><i class="fa fa-download"></i> Download</a>
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
									...
									<button type="submit" class="btn btn-danger btn-rounded"><?php echo $action; ?> AQAR</button>
