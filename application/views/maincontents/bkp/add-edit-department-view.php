...
<div class="page-header">
  <div class="page-header-content">
    ...
    <ul class="breadcrumb">
      ...
      <li><a href="<?php echo base_url(); ?>index.php/admin/manage_department">Manage Department</a></li>
      ...
      <div class="panel panel-flat">
        ...
        <div class="panel-body no-padding-bottom"> 
          ...
          <div class="form-group">
            ...
            <div class="col-lg-8">              
              <?php 
				$js = 'class="form-control" id=discipline_id';
				echo form_dropdown('discipline_id',$departments,$discipline_id,$js);
				echo form_error('discipline_id'); 
			  ?></div>
          </div>
          <div class="form-group">
								...
								<div class="col-lg-8">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter Number Of Intake" name="intake" value="<?php if($action == 'Edit'){echo $intake;} else {echo set_value('intake');} ?>">
          ...
          <div class="form-group">
            ...
            <div class="col-lg-8">
              <button type="submit" class="btn btn-danger btn-rounded"><?php echo $action; ?> Department</button>
            </div>
          </div>
