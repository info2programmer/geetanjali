...
<div class="page-header">
  <div class="page-header-content">
    ...
    <ul class="breadcrumb">
      ...
      <li><a href="<?php echo base_url(); ?>index.php/admin/manage_ads/inner_page_ad">Manage Inner Page Ad</a></li>
      <li class="active"><?php echo $action; ?> Inner Page Ad</li>
    </ul>
  </div>
</div>
<!-- /page header -->
      ...
      <div class="panel panel-flat">
        ...
        <div class="panel-body no-padding-bottom">
          ...
          <div class="form-group">
            ...
            <div class="col-lg-8">
              <?php 
				$js = 'class="form-control" id=page_name';
				echo form_dropdown('page_name',$pages,$page_name,$js);
				echo form_error('page_name'); 
			?>
            </div>
          </div>
          <div class="form-group">
            <label class="control-label col-lg-4">Inner Page Ad Expiry date</label>
            <div class="col-lg-8">
              <div class="input-group"> <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                <input type="text" class="form-control pickadate-selectors" placeholder="Select Inner Page Ad Expiry date" name="expiry_date" value="<?php if($action == 'Edit'){echo $expiry_date;} else {echo set_value('expiry_date');} ?>">
              </div>
              <?php echo form_error('expiry_date'); ?> </div>
          </div>
          <!--<div class="form-group">
            <label class="control-label col-lg-4">Inner Page Ad Rank</label>
            <div class="col-lg-8">
              <div class="input-group"> <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                <select name="ad_rank" class="form-control">
                	<option value="" selected="selected" hidden>Choose Ad Rank</option>
                    <?php for($i=1;$i<=3;$i++) { ?>
                    <option value="<?php echo $i; ?>"><?php echo $i; ?></option>
                    <?php } ?>
                </select>
              </div>
              <?php echo form_error('ad_rank'); ?> </div>
          </div>-->
          <div class="form-group">
            <label class="control-label col-lg-4">Inner Page Ad</label>
            <div class="col-lg-8">
              <?php if($action == 'Edit') { ?>
          ...
          <div class="form-group">
            ...
            <div class="col-lg-8">
              <button type="submit" class="btn btn-danger btn-rounded"><?php echo $action; ?> Inner Page Ad</button>
            </div>
          </div>
