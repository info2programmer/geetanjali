		...
		<div class="row">
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				...
				<div class="panel panel-flat">
                    	...
                    	<a href="<?php echo base_url();?>index.php/admin/manage_books/add" class="btn bg-teal-400 btn-labeled btn-rounded"><b><i class="fa fa-hand-o-right"></i></b>Add Books</a>												
									...
									<ul class="icons-list">
										...
										<li class="dropdown">
											...
											<ul class="dropdown-menu dropdown-menu-right">
												...
												<li><a target="_blank" href="<?php echo base_url(); ?>uploads/books/<?php echo $row->slider_image; ?>"><i class="fa fa-download"></i> Download</a></li>

												<!--<li><a href="datatable_advanced.htm#"><i class="fa fa-print"></i> Print</a></li>-->

												<li class="divider"></li>

												<li><a href="<?php echo base_url(); ?>index.php/admin/manage_books/edit/<?php echo $row->id; ?>"><i class="fa fa-edit"></i> Edit</a></li>

												<li><a onclick="return confirm('Are you sure?')" href="<?php echo base_url(); ?>index.php/admin/manage_books/confirmDelete/<?php echo $row->id; ?>"><i class="fa fa-trash"></i> Delete</a></li>

                                                

                                                <?php if($row->published==1) { ?>

                                                <li><a onclick="return confirm('Are you sure?')" href="<?php echo base_url(); ?>index.php/admin/manage_books/deactive/<?php echo $row->id; ?>"><i class="icon icon-cross2"></i> Deactivate</a></li>

                                                <?php } else { ?>

                                                <li><a onclick="return confirm('Are you sure?')" href="<?php echo base_url(); ?>index.php/admin/manage_books/active/<?php echo $row->id; ?>"><i class="icon icon-checkmark3"></i> Activate</a></li>
