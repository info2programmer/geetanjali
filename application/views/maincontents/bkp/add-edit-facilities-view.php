...
<div class="page-header">
  <div class="page-header-content">
    ...
    <ul class="breadcrumb">
      ...
      <li><a href="<?php echo base_url(); ?>index.php/admin/manage_facilities">Manage Facilities</a></li>
      ...
      <div class="panel panel-flat">
        ...
        <div class="panel-body no-padding-bottom"> 
          ...
          <div class="form-group">
            <label class="control-label col-lg-4">Facilities Name</label>
            <div class="col-lg-8">
              <input type="text" class="form-control" placeholder="Enter Department Name" name="facilities_name" value="<?php if($action == 'Edit'){echo $facilities_name;} else {echo set_value('facilities_name');} ?>">
              <?php echo form_error('facilities_name'); ?> </div>
          </div>
          <div class="form-group">
