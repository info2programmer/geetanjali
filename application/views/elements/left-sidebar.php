   ...
   <li class="nav-level">HRM</li>
    ...
    <li class="treeview"><a class="waves-effect waves-dark" href="#!"><i class="icon-film"></i> <span> Settings</span><i class="icon-arrow-down"></i></a>
      <ul class="treeview-menu">
        ...
        <li class="<?php if($this->uri->segment(2)=='WeightUnit') { ?>active <?php } ?>"><a class="waves-effect waves-dark" href="<?php echo base_url();?>view/WeightUnit"><i class="icon-arrow-right"></i> Weight Unit</a></li>
      </ul>
    </li>
     <li class="treeview"><a class="waves-effect waves-dark" href="#!"><i class="icon-film"></i> <span> Inventory Management</span><i class="icon-arrow-down"></i></a>
      ...
      <li><a class="waves-effect waves-dark" href="<?php echo base_url();?>view/Purchase"><i class="icon-arrow-right"></i>Purchase & Item Management</a></li>
