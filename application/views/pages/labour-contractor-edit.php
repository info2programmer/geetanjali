                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="md-input-wrapper">
                                        <input type="text" class="md-form-control required" placeholder="Contractor-Name" name="sname" id="sname" value="<?php echo $row->contractor_name ?>"/>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="md-input-wrapper">
                                        <input type="text" class="md-form-control validate-email required" placeholder="Contractor-Email" name="semail" id="semail" value="<?php echo $row->contractor_email ?>"/>
                                    </div>
                                </div>
                            </div>
                             <div class="row">
                                <div class="col-sm-6">
                            <div class="md-input-wrapper">
                                <input type="text" class="md-form-control validate-number" placeholder="Contractor-Phone" name="sphn" id="sphn" value="<?php echo $row->contractor_phone ?>"/>
                            </div>
                            </div>
                            <div class="col-sm-6">
                            <div class="md-input-wrapper">
                                <input type="text" class="md-form-control validate-alphanum required" placeholder="Contractor-PAN-No" name="span" id="span" value="<?php echo $row->contractor_pan ?>"/>
                            </div>
                            </div>
                            
                            </div>
                           <div class="md-input-wrapper">
                                <textarea class="md-form-control required" cols="2" rows="3" placeholder="Contractor-Address" name="sadd" id="sadd"><?php echo $row->contractor_address ?></textarea>
                            </div>
                            <input type="hidden" name="edit_id" value="<?php echo $edit_id ?>" >
                            <button type="submit" class="btn btn-success waves-effect waves-light m-r-30" name="btnSubmit" value="submit">Update</button>
                        </div>
                        </form>
                    </div>
                </div>
