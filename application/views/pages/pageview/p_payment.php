    ...
    <div class="row">
      <div class="col-sm-12 p-0">
        <div class="main-header">
          <h4># <?php echo $bl_no;?> Purchase Payments Details</h4>
      ...
      <div class="col-sm-12">
        <div class="card">
          ...
          <div class="card-block">
			...
			$paid_amtcnt = $this->db->query('SELECT * FROM td_purchase_payment WHERE bill_no="'.$row['p_bill_no'].'"')->num_rows();
			if($paid_amtcnt > 0){
			$paid_amt = $this->db->query('SELECT * FROM td_purchase_payment WHERE bill_no="'.$row['p_bill_no'].'"')->result_array();
			}
			?>
              <tr>
              	<td><?php echo $bl_no;?></td>
                <td><?php echo $row['p_bill_total']; ?></td>
                <td><?php if($paid_amtcnt > 0){ foreach($paid_amt as $pay_amt){?>Paid Rs. : <b><?php echo $pay_amt['paid_amt']; ?></b> ON <b><?php echo $pay_amt['pay_date']; ?></b><br/><?php echo $pay_amt['pay_through']; ?>  No : <?php echo $pay_amt['trans_no']; ?><br/><?php } } else echo 'No Payment yet';?></td>
                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-header-text">Update Payment</h5>
                            
                        </div>
                        
                        <!-- end of modal -->
						<form name="clientform" id="signupform" method="post" action="<?php echo base_url();?>index.php/accounts/PurchaseCollect" enctype="multipart/form-data">
                        <input type="hidden" name="bill_no" value="<?php echo $bl_no;?>" />
                        <div class="card-block">
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="md-input-wrapper">
                                    <input data-wtf type="text" class="md-form-control required" placeholder="Payable Amount" name="amount"/>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="md-input-wrapper">
