      ...
      <div class="col-sm-12 p-0">
        <div class="main-header">
          ...
          <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
            ...
            <li class="breadcrumb-item"><a href="<?php echo base_url();?>View/Sales">Sale Details</a></li>
          </ol>
        </div>
      </div>
    </div>
			...
			?>
              <tr>
                ...
                <?php if($row['stat']==0){ ?>
                    ...
                    <?php } ?>
                    <?php if($row['stat']==1){ ?>CANCELED<?php }?>
					<button type="button" class="btn btn-inverse-primary waves-effect waves-light " data-toggle="tooltip" data-placement="top" title=""><a href="<?php echo base_url();?>View/SaleItems/<?php echo $row['p_bill_id']; ?>" style="color:#FF0000;">See Details</a></button>
                </td>
              </tr>
            <?php } } else { ?>
            	<tr>
