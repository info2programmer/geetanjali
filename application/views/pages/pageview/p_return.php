    ...
    <div class="row">
      <div class="col-sm-12 p-0">
        <div class="main-header">
          <h4>Purchase Details of Bill No # <?php echo $bl_no;?></h4>
      ...
      <div class="col-sm-12">
        <div class="card">
          ...
          <div class="card-block">
           <form name="companyform" id="pcform" method="post" action="<?php echo base_url();?>index.php/Update/returnPurchase" enctype="multipart/form-data">
