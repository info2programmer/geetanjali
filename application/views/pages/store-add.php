            ...
            <div class="row">
                ...
                <div class="col-xl-12">
                    <div class="card">
                        ...
                        <!-- end of modal -->
						<form name="companyform" id="signupform" method="post" action="<?php echo base_url();?>index.php/add/Store" enctype="multipart/form-data">
                        <div class="card-block">
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="md-input-wrapper">
                                        <input type="text" class="md-form-control required" placeholder="Store-Name" name="stname"/>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="md-input-wrapper">
                                        <input type="text" class="md-form-control required" placeholder="Store-No" name="stno"/>
                                    </div>
                                </div>
                                 <div class="col-sm-6">
                                    <div class="md-input-wrapper">
                                      <select class="md-form-control required" name="stkeep">
                                            <option>Select Store Keeper</option>
