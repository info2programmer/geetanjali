        ...
        <td valign="top">
            <table class="bill">
                ...
                <tr>
                  ...
                  <th width="54%" rowspan="2">DESCRIPTION</th>
                ...
                <tr>
                    <td height="360" colspan="6" style="padding: 0!important; border: none!important; position: relative">
						...
						$uprc = ($bitems['item_unit_p_price']*$bitems['item_p_qty']);
						?>
                        <?php 
			  $amount = explode(".", number_format($uprc,2)); 
			  ?>
                            <tr>
                                <td width="10%"><?php echo $bitems['item_p_qty'];?> <?php echo $unit[0]['stname']; ?></td>
                                <td width="54%"><?php echo $bitems['item_name'];?></td>
                                <td width="10%"><?php echo $bitems['item_unit_p_price'];?></td>
                ...
                <tr>
                    <th colspan="2"></th>
                    <th>Total</th>
                    <th><?php $expamt = explode(".", number_format((array_sum($tprice)-$billdata[0]['discount_amt']),2));?><?php echo $expamt[0];?></th>
