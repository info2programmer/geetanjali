...
<table class="bill-outer">
        ...
        <th>
            <table>
                <tr>
                    ...
                    <td width="40%" align="right" valign="top">Mobile : +919804212728</td>
                </tr>
            </table>
        </th>
    </tr>
            ...
            <table>
                <tr>
                    ...
                    <td width="64%" align="center" valign="top">
                        <span style="font-family: 'Segoe UI Black'; font-size: 28px; line-height: 32px">GITANJALI DEVELOPER</span><br>
                        <!-- <span style="font-size: 18px; line-height: 22px; font-style: italic">Wholesale Dealers in Pulses Goods</span><br> -->
                        <span style="font-family: 'Gill Sans MT Condensed'; font-size: 16px">BD 61 action Area -I  new town</span>
                        <span style="font-family: 'Gill Sans MT Condensed'; font-size: 16px">Near 4 no tank </span>
                        <span style="font-family: 'Gill Sans MT Condensed'; font-size: 16px">Kolkata - 700156 </span>
                    </td>
    ...
    <tr>
        <td>
            <table>
                <tr>
                    <td width="61" align="left" valign="top" style="font-family: 'Gill Sans MT'; font-size: 16px; font-weight: bold">Name</td>
                  <td width="428" align="left" valign="top" style="font-family: 'Gill Sans MT'; font-size: 16px"><?php echo $customer[0]['clname'];?></td>
              </tr>
                <tr>
    ...
    <tr>
        <td valign="top">
            <table class="bill">
                <thead>
                <tr>
                    <th width="16%" rowspan="2">Qty.</th>
                    <th width="36%" rowspan="2">DESCRIPTION</th>
                    <th width="10%" rowspan="2">GST (%)</th>
                ...
                <tr>
                    <td height="360" colspan="6" style="padding: 0!important; border: none!important; position: relative">
						...
						?>
                        <?php 
			  $amount = explode(".", number_format($bitems['item_p_total_amt'],2)); 
			  ?>
                            <tr>
                                <td width="16%"><?php echo $bitems['item_p_qty'];?> <?php echo $unit[0]['stname']; ?></td>
                                <td width="36%"><?php echo $bitems['item_name'];?></td>
                                <td width="10%"><?php echo $bitems['item_s_gst'];?></td>
