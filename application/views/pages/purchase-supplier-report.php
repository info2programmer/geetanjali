        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="main-header">
                    <h4>Purchase Report / Supplier</h4>
                    <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                        ...
                        <li class="breadcrumb-item">Purchase Report / Supplier
                        </li>
                    </ol>
            ...
            <div class="row">
                ...
                <div class="col-xl-12">
                    <div class="card">
                        ...
                        <!-- end of modal -->
						<form name="companyform" id="signupform" method="post" action="<?php echo base_url();?>index.php/Reports/SearchPurchaseSupplier" enctype="multipart/form-data">
                        <div class="card-block">
                            <div class="row">
                               <div class="col-sm-12">
                                <div class="md-input-wrapper multisugg">
                                    <div class="md-input-wrapper multisugg">
                                        <input type="text" class="md-form-control" placeholder="Supplier Name" name="empname"/>
