      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td width="48" align="center" valign="top"><table width="100%" border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse; border-top: 2px solid #000000; font-family: Arial, Helvetica, sans-serif;">
            <tr>            
            <?php 
			//$ob1ead = $this->db->query("SELECT sum(advance) as op_adv FROM `td_expense` where entry_date<='$fdate' and transaction_type='Credit'")->row();
            ...
            <?php } } ?>
            <tr>
              <td height="25" colspan="7" align="right" valign="middle" class="style6"><span style="font-weight:bold;font-style:italic;">Closing Balance : Rs. <?php echo number_format(($ob1->op_bal1+$cb1->cl_bal1),2);?>&nbsp;</span></td>
            </tr>
          </table></td>
          <td width="4%">&nbsp;</td>
          <td width="48%" align="center" valign="top"><table width="100%" border="1" cellspacing="0" cellpadding="0" style="border-collapse: collapse; border-top: 2px solid #000000; font-family: Arial, Helvetica, sans-serif;">
		  ...
		  ?>
            ...
            <?php } } ?>
            <tr>
              <td height="25" colspan="7" align="right" valign="middle" class="style6"><span style="font-weight:bold;font-style:italic;">Closing Balance : Rs. <?php echo number_format(($ob2->op_bal2+$cb2->cl_bal2),2);?>&nbsp;</span></td>
            </tr>
          </table></td>
        </tr>
      </table>
