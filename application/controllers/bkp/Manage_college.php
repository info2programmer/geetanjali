...
class Manage_college extends CI_Controller {
	...
	function index()
	{
		...
		$data['maincontent']=$this->load->view('admin/maincontents/manage-college-list-view',$data,true);
...
/*
	...
	function confirmDelete($id)
	{
		...
		if($this->session->flashdata('error_message'))
		{
			...
			$College_details = $this->db->query("select * from td_users where id='$id'")->row();
			$image_file = $College_details->logo_image;			
			...
			if($resume_file!='') {
			unlink(FCPATH . '/uploads/college/' . $resume_file);
			}			
	...
	function deactive($id)
	{
		...
		if($deactive)
			{	
				$this->session->set_flashdata('success_message','College successfully deactivated');	
				redirect('admin/manage_college');
			}
		else
			{
	...
	function active($id)
	{
		...
		if($deactive)
			{	
				$this->session->set_flashdata('success_message','College successfully activated');	
				redirect('admin/manage_college');
			}
		else
			{	
	...
	function newsletter()
	{
		$user_details = $this->db->query("select email from td_users where user_type='C'")->result();
