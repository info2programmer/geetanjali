...
! function(a) {
    ...
    e.DEFAULTS = {
        ...
        })), this.options.addDisplayAllBtn && (this.$displayAllBtn = a('<button class="btn btn-default">Display all</button>'), this.$dropdownGroup.append(this.$displayAllBtn), this.$table.hasClass("display-all") , this.$displayAllBtn.click(function() {
        ...
        this.clearAllFocus(), this.$focusBtn , this.$table.toggleClass("focus-on")
        ...
        this.$displayAllBtn , this.$table.toggleClass("display-all", b), this.$tableClone && this.$tableClone.toggleClass("display-all", b), c && a(window).trigger(this.displayAllTrigger)
